          ...
          >
            {LANG_OPTIONS.map(({ value, label, flag }) => (
              ...
              >
                ...
                {value === locale && (
                  <svg className="h-3.5 w-3.5 text-amber-500" viewBox="0 0 24 24" fill="none" strokeWidth={2.5} stroke="currentColor">
        ...
        >
          {LANG_OPTIONS.map(({ value, label, flag }) => (
            ...
            >
              ...
              <span className="flex-1 text-left">{label}</span>
              {value === locale && (
                <svg className="h-4 w-4 text-amber-500" viewBox="0 0 24 24" fill="none" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                </svg>
              )}
            </button>
