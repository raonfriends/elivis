          ...
          {STATUS_ORDER.map((st) => {
            ...
            return (
              ...
              >
                ...
                <span className={`font-medium ${isActive ? "text-stone-800" : "text-stone-500"}`}>
                  {tStatus(st)}
                </span>
                {isActive && (
                  <svg className="ml-auto h-3 w-3 shrink-0 text-stone-400" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
