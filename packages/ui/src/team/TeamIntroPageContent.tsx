...
>(function TeamIntroPageContent(
    { team, onLayoutEditModeChange, updateTeamFields, onAfterTeamFieldsMutation },
    ref,
) {
        ...
        <div className="relative">
            ...
            {isLeader ? (
                <TeamIntroLayoutSettingsPanel
                    ...
                    onAfterMutation={onAfterTeamFieldsMutation}
                />
            ) : null}
        </div>
    );
