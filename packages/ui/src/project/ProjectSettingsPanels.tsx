...
export function ProjectSettingsProjectTab({
    ...
    settingsActions: Pick<
        ...
        "updateProject" | "searchUsers" | "addProjectMember"
    >;
}) {
    ...
    const handleSave = () => {
        ...
        setError(null);
        startSave(async () => {
            const r = await settingsActions.updateProject(project.id, {
                name: trimmed,
        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <ProjectAddMemberModal
                    ...
                    onSuccess={onUpdated}
                    searchUsers={settingsActions.searchUsers}
                    addProjectMember={settingsActions.addProjectMember}
                />
            </div>
        </div>
    );
...
export function ProjectSettingsSecurityTab({
    project,
    settingsActions,
    onAfterProjectDelete,
}: {
    project: Project;
    settingsActions: Pick<ProjectSettingsActions, "deleteProject">;
    onAfterProjectDelete: () => void;
}) {
    const isLeader = project.viewerRole === "LEADER";
                        ...
                        <div className="mt-5 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
                            ...
                            <button
                                ...
                                onClick={() => {
                                    setDeleteError(null);
                                    startDelete(async () => {
                                        const r = await settingsActions.deleteProject(project.id, project.name);
                                        if (!r.ok) {
